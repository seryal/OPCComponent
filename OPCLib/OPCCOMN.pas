...
type
  ...
  IOPCServerList = interface(IUnknown)
    ...
    function EnumClassesOfCategories(cImplemented: ULONG; rgcatidImpl: PGUIDList;
      cRequired: ULONG; rgcatidReq: PGUIDList;
      out ppenumClsid: IEnumGUID): HResult; stdcall;
    function GetClassDetails(const clsid: TCLSID; out ppszProgID: POleStr;
      out ppszUserType: POleStr): HResult; stdcall;
    function CLSIDFromProgID(szProgId: POleStr; out clsid: TCLSID): HResult; stdcall;
  end;
  ...
  IOPCEnumGUID = interface(IUnknown)
    ...
    function Next(celt: UINT; out rgelt: TGUID;
  ...
  IOPCServerList2 = interface(IUnknown)
    ...
    function GetClassDetails(const clsid: TCLSID; out ppszProgID: POleStr;
      out ppszUserType: POleStr; out ppszVerIndProgID: POleStr): HResult; stdcall;
    function CLSIDFromProgID(szProgId: POleStr; out clsid: TCLSID): HResult; stdcall;
  end;
